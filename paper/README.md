...
- [`manuscript_draft_v0.2.md`](manuscript_draft_v0.2.md) — **current draft**, 1 August 2026. *Vanishing Winners: Interval-Censored Survival of Signal-Provider Visibility on a Public Copy-Trading Leaderboard, 2011–2026*. Zhennan (Nathan) Yu, independent researcher, Sydney. ~13,100 words in Sections 1–7.
